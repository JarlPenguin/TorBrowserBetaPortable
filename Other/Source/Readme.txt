...
user in an INI file next to TorBrowserBetaPortable.exe called TorBrowserBetaPortable.ini.
...
copy TorBrowserBetaPortable.ini from this directory to TorBrowserBetaPortable.ini next to
TorBrowserBetaPortable.exe. The options in the INI file are as follows:
